...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex min-h-screen">
        ...
        {{-- Sidebar --}}
        <aside id="sidebar" class="w-64 bg-blue-800 text-white flex flex-col fixed inset-y-0 left-0 z-40 -translate-x-full transition-transform duration-300 md:relative md:translate-x-0">
