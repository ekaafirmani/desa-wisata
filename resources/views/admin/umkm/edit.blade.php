...
@section('content')
    ...
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mt-2">Edit Lapak UMKM</h2>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-6 max-w-lg">
        ...
        <form method="POST" action="{{ route('admin.umkm.update', $lapak->id) }}" class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div>
                ...
                <input type="text" name="nama_pedagang"
                       value="{{ old('nama_pedagang', $lapak->nama_pedagang) }}"
            ...
            <div>
                ...
                <input type="text" name="nama_usaha"
                       value="{{ old('nama_usaha', $lapak->nama_usaha) }}"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
            </div>
            ...
            <div>
                ...
                <input type="text" name="jenis_usaha"
                       value="{{ old('jenis_usaha', $lapak->jenis_usaha) }}"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
            </div>
            ...
            <div>
                ...
                <input type="number" name="tarif_bulanan"
                       value="{{ old('tarif_bulanan', $lapak->tarif_bulanan) }}"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
            </div>
            ...
            <div>
                ...
                <input type="date" name="tanggal_mulai"
                       value="{{ old('tanggal_mulai', $lapak->tanggal_mulai->format('Y-m-d')) }}"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
            </div>
