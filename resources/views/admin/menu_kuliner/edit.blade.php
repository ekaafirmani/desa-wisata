...
@section('title', 'Edit Menu Kuliner')

@section('content')

    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Edit Menu Kuliner</h2>
    </div>

    <div class="bg-white rounded-xl shadow p-6 max-w-lg">
        <form method="POST" action="{{ route('admin.menu_kuliner.update', $menu->id) }}" class="space-y-4">
            @csrf
            @method('PUT')
