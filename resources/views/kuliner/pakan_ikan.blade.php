...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow p-6 lg:col-span-1">
            ...
            <form method="POST" action="{{ route('kuliner.pakan_ikan.simpan') }}" class="space-y-4">
                @csrf
                <div>
                ...
                <button type="submit"
                        class="w-full bg-purple-700 hover:bg-purple-800 text-white px-4 py-2 rounded-lg text-sm font-medium">
                    Simpan
                </button>
            </form>
        </div>
