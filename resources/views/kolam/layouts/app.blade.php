...
<body class="bg-gray-100 font-sans">
    ...
    <div
        class="md:hidden fixed top-0 left-0 right-0 z-50 bg-cyan-800 shadow px-4 py-3 flex items-center justify-between">
    ...
    <div class="flex min-h-screen">
        ...
        {{-- Sidebar --}}
        <aside id="sidebar"
            class="w-64 bg-cyan-800 text-white flex flex-col fixed inset-y-0 left-0 z-40 -translate-x-full transition-transform duration-300 md:relative md:translate-x-0">
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="{{ route('kolam.ikan_hias') }}"
                    class="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-cyan-700 {{ request()->routeIs('kolam.ikan_hias') ? 'bg-cyan-700' : '' }}">
                    <span>🐠</span> Ikan Hias
                </a>
            </nav>
